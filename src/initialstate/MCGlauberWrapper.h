...
public:
  ...
  */
  ...
  void GetAllTargNucleonIDs(std::vector<int> &id);
  void GetAllProjNucleonIDs(std::vector<int> &id);
...
private:
  ...
  std::vector<int> targ_nucleon_ids_;
  std::vector<int> proj_nucleon_ids_;
