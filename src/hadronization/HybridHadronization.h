...
private:
  ...
  double maxE_level, gmax, xmq, xms, hbarc, dist2cut, sh_recofactor,
      th_recofactor, p_fake;
  ...
  protected:
    ...
    bool is_shower_, is_thermal_, is_used_, is_decayedglu_, is_remnant_,
        used_reco_, used_str_, is_strendpt_;
    ...
    int alt_id_, orig_, par_, string_id_, pos_str_, endpt_id_, sibling_,
        PY_par1_, PY_par2_, PY_dau1_, PY_dau2_, PY_stat_, PY_origid_;
    //parton mass
    double alt_mass_;
