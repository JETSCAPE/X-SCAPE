...
class InitialState : public JetScapeModuleBase {
  ...
  */
  ...
  virtual void SampleABinaryCollisionPoint(double &t, double &x, double &y,
                                           double &z);

  virtual double Get_total_nucleon_density_lab(double t, double x, double y,
                                               double z) {
    return 0.0;
  }

  virtual double Get_target_nucleon_density_lab(double t, double x, double y,
                                                double z) {
    return 0.0;
  }
  ...
  /**
   * @brief Gets number or grids along x-direction following trento convention.
  ...
  /**
   * @brief Gets number or grids along y-direction following trento convention.
  ...
  std::vector<FourVector> CollisionPositiveMomentum, CollisionNegativeMomentum,
      CollisionPositiveRotatedMomentum, CollisionNegativeRotatedMomentum;
