...
class JetScapeTask {
 public:
  ...
  /** Main execution function for a JetScapeTask overridden by different
   * modules/tasks.
   */
  ...
  */
  ...
  // add here a write task (depending on if JetScapeWriter is initialized and
  // active) ...
  ...
  */
  ...
  /** This function tells whether the task is active or not i.e. whether its
   * Exec() function is run.
   */
