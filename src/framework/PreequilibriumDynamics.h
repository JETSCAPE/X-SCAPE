...
class PreequilibriumDynamics : public JetScapeModuleBase {
 ...
 public:
   ...
   * Initial State Physics information. Calls InitializeHydro(parameter_list)
   * and InitTask(); This explicit call can be used for actual initialization of
   ...
   * @sa Read about @a polymorphism in C++. Override Init (not InitTask) here as
   * sub-tasks are called as well.
   */
  void Init() override;
   ...
   *
   * @return real The end time (or tau) for preequilibrium evolution
   */
