...
class JetScapeModuleBase
 ...
 public:
  ...
  /** A virtual function to define a default execute function for a
   * JetScapeModuleBase. It is overridden by different modules/tasks.
   */
  ...
  // Override execute tasks (at least for now) to keep is-time-stepped handling
  // on module level and not include in JetScapeTask
  virtual void ExecuteTasks() override;

  // Override clear tasks (at least for now) to keep is-time-stepped handling on
  // module level and not include in JetScapeTask
