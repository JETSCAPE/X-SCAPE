...
class FluidDynamics : public JetScapeModuleBase {
 protected:
  ...
  /** A weak pointer to the hadronic liquefier object. */
 ...
 public:
   ...
   * @param y The spatial coordinate (y).
   * @param z The spatial or eta coordinate (z or eta).
   * @param bulk_info_ptr A unique pointer to a `BulkMediaInfo`
   * object where the retrieved bulk information will be stored.
   */
