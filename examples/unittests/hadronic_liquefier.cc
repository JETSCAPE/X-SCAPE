...
TEST(HadronicLiquefierTest, CreateValidHadronTest) {
  ...
  Hadron had =
      Hadron(label, id, stat, p, x, mass, charge, baryon_number, strangeness);
  ...
  HadronDroplet drop = HadronDroplet(js_real_array_x, js_real_array_p,
...
TEST(HadronicLiquefierTest, SmearingKernelFunctionTest) {
  ...
  double tau = 1.0;
  double gamma = 1.0;
  double expected_result_cov =
      1. / (pow(M_PI, 1.5) * pow(lqf.get_sigma_transverse(), 3.0));
  double expected_result_gauss =
      1. / (sqrt(M_PI) * lqf.get_sigma_longitudinal() * M_PI *
            pow(lqf.get_sigma_transverse(), 2.0));
...
TEST(HadronicLiquefierTest,
     TestComputeDropletKernelNormalizationCovariantMilne) {
...
TEST(HadronicLiquefierTest,
     TestComputeDropletKernelNormalizationCovariantCartesian) {
...
TEST(HadronicLiquefierTest,
     TestComputeDropletKernelNormalizationGaussCartesian) {
...
TEST(HadronicLiquefierTest, TestGetSourceEnergyCovariantMilne) {
  ...
  HadronicLiquefier lqf_cov_Milne(true, 0.5, 0.5, 15., 15., 15., 228, 228, 228,
                                  false);
  ...
  for (int ieta = 0; ieta < lqf_cov_Milne.get_Nz(); ieta++) {
    for (int ix = 0; ix < lqf_cov_Milne.get_Nx(); ix++) {
      for (int iy = 0; iy < lqf_cov_Milne.get_Ny(); iy++) {
        const double eta =
            -lqf_cov_Milne.get_zMax() + ieta * lqf_cov_Milne.get_dz();
        const double x =
            -lqf_cov_Milne.get_xMax() + ix * lqf_cov_Milne.get_dx();
        const double y =
            -lqf_cov_Milne.get_yMax() + iy * lqf_cov_Milne.get_dy();
  ...
  total_energy *= (tau * lqf_cov_Milne.get_dx() * lqf_cov_Milne.get_dy() *
                   lqf_cov_Milne.get_dz());
...
TEST(HadronicLiquefierTest, TestGetSourceEnergyCovariantCartesian) {
  // Create a HadronicLiquefier object for testing
  HadronicLiquefier lqf_cov_Cartesian(true, 0.5, 0.5, 15., 15., 15., 128, 128,
                                      128, true);
  ...
  for (int ieta = 0; ieta < lqf_cov_Cartesian.get_Nz(); ieta++) {
    for (int ix = 0; ix < lqf_cov_Cartesian.get_Nx(); ix++) {
      for (int iy = 0; iy < lqf_cov_Cartesian.get_Ny(); iy++) {
        const double eta =
            -lqf_cov_Cartesian.get_zMax() + ieta * lqf_cov_Cartesian.get_dz();
        const double x =
            -lqf_cov_Cartesian.get_xMax() + ix * lqf_cov_Cartesian.get_dx();
        const double y =
            -lqf_cov_Cartesian.get_yMax() + iy * lqf_cov_Cartesian.get_dy();
  ...
  total_energy *= (lqf_cov_Cartesian.get_dx() * lqf_cov_Cartesian.get_dy() *
                   lqf_cov_Cartesian.get_dz());
...
TEST(HadronicLiquefierTest, TestGetSourceEnergyGaussMilne) {
  // Create a HadronicLiquefier object for testing
  HadronicLiquefier lqf_Gauss_Milne(false, 0.5, 0.5, 15., 15., 15., 128, 128,
                                    128, false);
  ...
  for (int ieta = 0; ieta < lqf_Gauss_Milne.get_Nz(); ieta++) {
    for (int ix = 0; ix < lqf_Gauss_Milne.get_Nx(); ix++) {
      for (int iy = 0; iy < lqf_Gauss_Milne.get_Ny(); iy++) {
        const double eta =
            -lqf_Gauss_Milne.get_zMax() + ieta * lqf_Gauss_Milne.get_dz();
        const double x =
            -lqf_Gauss_Milne.get_xMax() + ix * lqf_Gauss_Milne.get_dx();
        const double y =
            -lqf_Gauss_Milne.get_yMax() + iy * lqf_Gauss_Milne.get_dy();
  ...
  // dz = tau * deta in this case
  total_energy *= (tau * lqf_Gauss_Milne.get_dx() * lqf_Gauss_Milne.get_dy() *
                   lqf_Gauss_Milne.get_dz());
...
TEST(HadronicLiquefierTest, TestGetSourceEnergyGaussCartesian) {
  // Create a HadronicLiquefier object for testing
  HadronicLiquefier lqf_Gauss_Cartesian(false, 0.5, 0.5, 15., 15., 15., 128,
                                        128, 128, true);
  ...
  for (int ieta = 0; ieta < lqf_Gauss_Cartesian.get_Nz(); ieta++) {
    for (int ix = 0; ix < lqf_Gauss_Cartesian.get_Nx(); ix++) {
      for (int iy = 0; iy < lqf_Gauss_Cartesian.get_Ny(); iy++) {
        const double eta = -lqf_Gauss_Cartesian.get_zMax() +
                           ieta * lqf_Gauss_Cartesian.get_dz();
        const double x =
            -lqf_Gauss_Cartesian.get_xMax() + ix * lqf_Gauss_Cartesian.get_dx();
        const double y =
            -lqf_Gauss_Cartesian.get_yMax() + iy * lqf_Gauss_Cartesian.get_dy();
  ...
  total_energy *= (lqf_Gauss_Cartesian.get_dx() * lqf_Gauss_Cartesian.get_dy() *
                   lqf_Gauss_Cartesian.get_dz());
...
TEST(HadronicLiquefierTest, TestGetSourceQuantityZero) {
  ...
  // dz = tau * deta in this case
  total_rhob *= (tau * lqf_cov_Milne.get_dx() * lqf_cov_Milne.get_dy() *
                 lqf_cov_Milne.get_dz());
  total_rhoq *= (tau * lqf_cov_Milne.get_dx() * lqf_cov_Milne.get_dy() *
                 lqf_cov_Milne.get_dz());
  total_rhos *= (tau * lqf_cov_Milne.get_dx() * lqf_cov_Milne.get_dy() *
                 lqf_cov_Milne.get_dz());
...
TEST(HadronicLiquefierTest, TestGetSourceQuantityCovariantCartesian) {
  // Create a HadronicLiquefier object for testing
  HadronicLiquefier lqf_cov_Cartesian(true, 0.5, 0.5, 15., 15., 15., 228, 228,
                                      228, false);
  ...
  total_rhob *= (lqf_cov_Cartesian.get_dx() * lqf_cov_Cartesian.get_dy() *
                 lqf_cov_Cartesian.get_dz());
...
TEST(HadronicLiquefierTest, TestGetSourceQuantityGaussMilne) {
  // Create a HadronicLiquefier object for testing
  HadronicLiquefier lqf_Gauss_Milne(false, 0.5, 0.5, 15., 15., 15., 228, 228,
                                    228, false);
  ...
  // dz = tau * deta in this case
  total_rhob *= (tau * lqf_Gauss_Milne.get_dx() * lqf_Gauss_Milne.get_dy() *
                 lqf_Gauss_Milne.get_dz());
...
TEST(HadronicLiquefierTest, TestGetSourceQuantityGaussCartesian) {
  // Create a HadronicLiquefier object for testing
  HadronicLiquefier lqf_Gauss_Cartesian(true, 0.5, 0.5, 15., 15., 15., 228, 228,
                                        228, false);
  ...
  total_rhob *= (lqf_Gauss_Cartesian.get_dx() * lqf_Gauss_Cartesian.get_dy() *
                 lqf_Gauss_Cartesian.get_dz());
